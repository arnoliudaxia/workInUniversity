...
loop:
	slli t3, t0, 2 # t3=k*4
	add t4, t1, t3# t4 是数组指针, t1是基址,t3是offset
	lw t5, 0(t4)# t5 = source[k]
	beq t5, x0, exit # if (t5)source[k]==0 exit
	add t6, t2, t3 # t6 = dest + offset
	#!!!!!!!!!  t5*=2
	slli t5,t5,1
	sw t5, 0(t6) #(t6)dest[k] = (t5)source[k]
	addi t0, t0, 2 #!!!!!!!!! k+=2
	jal x0, loop
exit:
	jal ra, print_lists
